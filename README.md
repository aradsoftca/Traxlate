...
<img src="assets/traxlate-mark.svg" alt="Traxlate" width="80" height="80" />
...
![Traxlate on the web](assets/web-home-light.png)
...
**29 minutes** on a desktop with an NVIDIA RTX 3070, with no internet connection. Every chapter,
...
<img src="assets/phone-translate.png" alt="Traxlate on an Android phone translating two English sentences into Spanish in 2 seconds, on the device" />
<p align="center"><sub>On a Galaxy Z Fold5 — two sentences into Spanish in 2.0 s, <b>on the phone</b>.</sub></p>
</td>
<td valign="top">
<img src="assets/desktop-app.png" alt="The Traxlate desktop app translating an English sentence into French" />
<p align="center"><sub>The desktop app — Windows, macOS and Linux.</sub></p>
<br/>
<img src="assets/phone-search.png" alt="The language picker: type a few letters to find any of 66 languages by its English or native name" width="70%" />
<p><sub>Find any of the 66 languages by typing its English or native name.</sub></p>
</td>
</tr>
</table>

<p align="center">
<img src="assets/word-ribbon.png" alt="The Traxlate tab in Microsoft Word's ribbon" /><br/>
<sub>The Traxlate tab inside Microsoft Word (Windows).</sub>
</p>
...
<p align="center"><img src="assets/quality-from-english.svg" alt="Translation quality from English into 14 languages, COMET-22 x 100, from 79.2 for Hindi to 91.0 for Indonesian" /></p>

<p align="center"><img src="assets/quality-both-directions.svg" alt="Quality in both directions for nine languages" /></p>

<p align="center"><img src="assets/quality-check.svg" alt="When the quality check rewrites a sentence, the rewrite scores higher 81 percent of the time: 198 better, 45 worse" /></p>
...
| Desktop with an NVIDIA RTX 3070 | **29 min** for a 52,819-word novel (EPUB, English → Spanish) |
